...
Make sure you :
1) Have given "hcr_parrun.sh" execution permission (maybe via "chmod +x hcr_parrun.sh").
2) Are executing the script from the root directory of this respository.
3) Have your virtual environment activated.
